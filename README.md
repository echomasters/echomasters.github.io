...
一个基于 [WebStackPage](https://github.com/WebStackPage/WebStackPage.github.io) 的极简、高效个人网址导航页。

[![Demo](https://img.shields.io/badge/Demo-nav.555212.xyz-blue?style=flat-square&logo=google-chrome)](http://nav.555212.xyz)
![License](https://img.shields.io/badge/License-MIT-green?style=flat-square)
![Style](https://img.shields.io/badge/Style-Minimalist-orange?style=flat-square)
...
- **[新增] `nav-data.js`**: 包含所有网站分类与链接的独立数据文件。
- **[新增] `nav-renderer.js`**: 自动读取数据并渲染左侧菜单栏及右侧卡片流。
...
基于 [WebStackPage](https://github.com/WebStackPage/WebStackPage.github.io) 项目开发。
© 2025 WebStack 个人版
